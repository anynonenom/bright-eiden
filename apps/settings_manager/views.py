...
SETTING_META = {
    ...
    "org.deletion_confirmation_link_expiry_hours": {"label": "Deletion link expiry (hours)", "type": "int", "group": "Data"},
    "org.publish_log_retention_days": {"label": "Publish log retention (days)", "type": "int", "group": "Data"},
    "org.webhook_delivery_log_retention_days": {"label": "Webhook log retention (days)", "type": "int", "group": "Data"},
    ...
    "org.email_batching_delay_minutes": {"label": "Email batching delay (minutes)", "type": "int", "group": "Notifications"},
    "infra.publishing_poll_seconds": {"label": "Publishing poll interval (seconds)", "type": "int", "group": "Infrastructure"},
    "infra.account_health_check_hours": {"label": "Account health check (hours)", "type": "int", "group": "Infrastructure"},
    "infra.token_refresh_check_hours": {"label": "Token refresh check (hours)", "type": "int", "group": "Infrastructure"},
    "infra.token_refresh_lookahead_hours": {"label": "Token refresh lookahead (hours)", "type": "int", "group": "Infrastructure"},
    "infra.max_concurrent_publish_jobs": {"label": "Max concurrent publish jobs", "type": "int", "group": "Infrastructure"},
    "infra.media_preprocessing_lookahead_minutes": {"label": "Media preprocessing lookahead (minutes)", "type": "int", "group": "Infrastructure"},
    "infra.recurrence_generation_interval": {"label": "Recurrence generation interval", "type": "str", "group": "Infrastructure"},
    "infra.cleanup_job_schedule": {"label": "Cleanup job schedule", "type": "str", "group": "Infrastructure"},
    "approval.internal_reminder_hours": {"label": "Internal reminder interval (hours)", "type": "int", "group": "Approvals"},
    "approval.client_reminder_hours": {"label": "Client reminder interval (hours)", "type": "int", "group": "Approvals"},
    ...
    "approval.email_subject_template": {"label": "Approval email subject template", "type": "str", "group": "Approvals"},
    "publishing.first_comment_delay_seconds": {"label": "First comment delay (seconds)", "type": "int", "group": "Publishing"},
    ...
    "scheduling.recurring_post_lookahead_days": {"label": "Recurring post lookahead (days)", "type": "int", "group": "Scheduling"},
    "scheduling.queue_empty_slot_warning_days": {"label": "Empty slot warning (days)", "type": "int", "group": "Scheduling"},
    ...
    "analytics.optimal_time_lookback_days": {"label": "Optimal time lookback (days)", "type": "int", "group": "Analytics"},
    "analytics.optimal_time_min_posts": {"label": "Optimal time min posts", "type": "int", "group": "Analytics"},
    "analytics.high_frequency_collection_hours": {"label": "High-frequency collection (hours)", "type": "int", "group": "Analytics"},
    ...
    "notifications.digest_mode": {"label": "Digest mode (batch notifications)", "type": "bool", "group": "Notifications"},
    "onboarding.client_connection_link_expiry_days": {"label": "Client connection link expiry (days)", "type": "int", "group": "Onboarding"},
}
